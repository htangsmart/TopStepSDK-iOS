...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../TopStepSDK/Frameworks/TopStepComKitSJ/h264encoder.framework"
  install_framework "${PODS_ROOT}/../../TopStepSDK/Frameworks/TopStepComKitSJ/SJWatchLib.framework"
  install_framework "${PODS_ROOT}/../../TopStepSDK/Frameworks/TopStepComKitSJ/UNIWatchMate.framework"
